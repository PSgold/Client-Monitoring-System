...
//////////////////////////////////Main Function//////////////////////////////////////////////
int startWork(ShaiG::logFile& dLog){
    #ifdef Debugging
    std::wcout<<L"Starting Function Work"<<L'\r'<<L'\n';
    #endif
    ...
    unsigned driveCount{static_cast<unsigned>(driveStr.length()/2)};
    #ifdef Debugging
    ...
    std::wstring ipAddress{L"192.168.10.35"};//server ip address
    ...
    ){closesocket(cSock);printE("failed to connect");WSACleanup();return -3;}
    ...
    if(send(cSock,serializedData1,sizeof(clientSystemInfo),MSG_OOB)==SOCKET_ERROR){
        ...
        printE("send1 failed");
        #endif
        closesocket(cSock);WSACleanup();return -4;
    }
    ...
    if(send(cSock,reinterpret_cast<char*>(&driveCount),4,MSG_OOB)==SOCKET_ERROR){
        ...
        printE("send2 failed");
        #endif
        closesocket(cSock);WSACleanup();return -5;
    }
    ...
    if(send(cSock,serializedData2,sizeof(driveInfo)*driveCount,MSG_OOB)==SOCKET_ERROR){
        ...
        printE("send3 failed");
        #endif
        closesocket(cSock);WSACleanup();return -6;
    }
    ...
    dLog.write("closed socket and wsacleanup");
    #ifdef Debugging
    std::wcout<<"closed sockets\n";
    //std::wcout<<confirmReception<<L'\n';
    #endif
    //////////////////////////////////////////create client socket/////////////////////////////////////
    ...
    #ifdef Debugging
    std::wcout.flush();
    std::wcout<<"Stopping function work\n";
    #endif
    return 1;
}
//////////////////////////////////Main Function//////////////////////////////////////////////
